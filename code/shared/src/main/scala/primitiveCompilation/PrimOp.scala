...
object PrimitiveOperations {
  val    ops: List[PrimOp] = List(NumEq, NumPlus, NumMult, NumMin, NumDiv, NumCos, NumSin, NumTan, NumAcos, NumAsin, NumAtan, Boolp, And, Or, Charp, Null, Lst, Cons, Car, Cdr, Vector, VectRef, VectSet, Eq)
