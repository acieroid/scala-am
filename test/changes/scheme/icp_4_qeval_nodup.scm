...
(define keep-if-unique (<change> #f (lambda (stream) ; <================================================================
                                      (cond ((stream-null? stream) the-empty-stream)
                                            ((stream-null? (stream-cdr stream)) stream)
                                            (else the-empty-stream)))))
(define unique-solution (<change> #f (lambda (args frame-stream) ; <====================================================
                                        (if (or (null? args) (not (null? (cdr args))))
                                                (error "expects 1 argument only")
                                                (let ((query (car args)))
                                                  (stream-flatmap
                                                   (lambda (frame)
                                                     (keep-if-unique
...
(<change> #f (put 'unique 'qeval unique-solution)) ; <==================================================================
