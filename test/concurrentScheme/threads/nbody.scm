...
(define (make-body x y z vx vy vz mass) (list (ref x) (ref y) (ref z)
                                              (ref vx) (ref vy) (ref vz)
                                              (ref mass)))
(define (body-x b) (deref (car b)))
(define (set-body-x! b v) (ref-set (car b) v))
(define (body-y b) (deref (cadr b)))
(define (set-body-y! b v) (ref-set (cadr b) v))
(define (body-z b) (deref (caddr b)))
(define (set-body-z! b v) (ref-set (caddr b) v))
(define (body-vx b) (deref (cadr (cddr b))))
(define (set-body-vx! b v) (ref-set (cadddr b) v))
(define (body-vy b) (deref (cadr (cdddr b))))
(define (set-body-vy! b v) (ref-set (cadr (cdddr b)) v))
(define (body-vz b) (deref (caddr (cdddr b))))
(define (set-body-vz! b v) (ref-set (caddr (cdddr b)) v))
(define (body-mass b) (deref (cadddr (cdddr b))))
(define (set-body-mass! b v) (ref-set (cadddr (cdddr b)) v))
