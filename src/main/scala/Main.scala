    ...
    Config.parser.parse(args, Config.Config()) match {
      case Some(config) => {
        ...
        val f = (config.anf, config.machine, config.lattice, config.concrete) match {
          ...
          case (true, Config.Machine.ConcurrentAAM, Config.Lattice.Concrete, true) => run(new ConcurrentAAM[ANFExp, AbstractConcrete, ConcreteAddress, ZeroCFA, ConcreteTID], new ANFSemantics[AbstractConcrete, ConcreteAddress, ZeroCFA]) _
          case (false, Config.Machine.ConcurrentAAM, Config.Lattice.Concrete, true) => run(new ConcurrentAAM[SchemeExp, AbstractConcrete, ConcreteAddress, ZeroCFA, ConcreteTID], new SchemeSemantics[AbstractConcrete, ConcreteAddress, ZeroCFA]) _
          case (true, Config.Machine.ConcurrentAAM, Config.Lattice.Concrete, false) => run(new ConcurrentAAM[ANFExp, AbstractConcrete, ClassicalAddress, ZeroCFA, ConcreteTID], new ANFSemantics[AbstractConcrete, ClassicalAddress, ZeroCFA]) _
          case (false, Config.Machine.ConcurrentAAM, Config.Lattice.Concrete, false) => run(new ConcurrentAAM[SchemeExp, AbstractConcrete, ClassicalAddress, ZeroCFA, ConcreteTID], new SchemeSemantics[AbstractConcrete, ClassicalAddress, ZeroCFA]) _
          case (true, Config.Machine.ConcurrentAAM, Config.Lattice.Type, true) => run(new ConcurrentAAM[ANFExp, AbstractType, ConcreteAddress, ZeroCFA, ConcreteTID], new ANFSemantics[AbstractType, ConcreteAddress, ZeroCFA]) _
          case (false, Config.Machine.ConcurrentAAM, Config.Lattice.Type, true) => run(new ConcurrentAAM[SchemeExp, AbstractType, ConcreteAddress, ZeroCFA, ConcreteTID], new SchemeSemantics[AbstractType, ConcreteAddress, ZeroCFA]) _
          case (true, Config.Machine.ConcurrentAAM, Config.Lattice.Type, false) => run(new ConcurrentAAM[ANFExp, AbstractType, ClassicalAddress, ZeroCFA, ConcreteTID], new ANFSemantics[AbstractType, ClassicalAddress, ZeroCFA]) _
          case (false, Config.Machine.ConcurrentAAM, Config.Lattice.Type, false) => run(new ConcurrentAAM[SchemeExp, AbstractType, ClassicalAddress, ZeroCFA, ConcreteTID], new SchemeSemantics[AbstractType, ClassicalAddress, ZeroCFA]) _
          case (true, Config.Machine.ConcurrentAAM, Config.Lattice.TypeSet, true) => run(new ConcurrentAAM[ANFExp, AbstractTypeSet, ConcreteAddress, ZeroCFA, ConcreteTID], new ANFSemantics[AbstractTypeSet, ConcreteAddress, ZeroCFA]) _
          case (false, Config.Machine.ConcurrentAAM, Config.Lattice.TypeSet, true) => run(new ConcurrentAAM[SchemeExp, AbstractTypeSet, ConcreteAddress, ZeroCFA, ConcreteTID], new SchemeSemantics[AbstractTypeSet, ConcreteAddress, ZeroCFA]) _
          case (true, Config.Machine.ConcurrentAAM, Config.Lattice.TypeSet, false) => run(new ConcurrentAAM[ANFExp, AbstractTypeSet, ClassicalAddress, ZeroCFA, ConcreteTID], new ANFSemantics[AbstractTypeSet, ClassicalAddress, ZeroCFA]) _
          case (false, Config.Machine.ConcurrentAAM, Config.Lattice.TypeSet, false) => run(new ConcurrentAAM[SchemeExp, AbstractTypeSet, ClassicalAddress, ZeroCFA, ConcreteTID], new SchemeSemantics[AbstractTypeSet, ClassicalAddress, ZeroCFA]) _
