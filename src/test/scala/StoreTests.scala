...
class ConcreteCountingStoreTest extends StorePropSpec[ClassicalAddress.A](Lattices.ConcreteLattice)
class TypeSetStoreTest extends StorePropSpec[ClassicalAddress.A](Lattices.TypeLattice)
class BoundedIntStoreTest extends StorePropSpec[ClassicalAddress.A](Lattices.BoundedIntLattice)
class ConstantPropagationStoreTest extends StorePropSpec[ClassicalAddress.A](Lattices.ConstantPropagationLattice)
