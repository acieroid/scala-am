...
object Graph {
  def apply[G, N <: GraphElement, E <: GraphElement]()(implicit g: Graph[G, N, E]): Graph[G, N, E] = g

  implicit class GraphOps[G, N <: GraphElement, E <: GraphElement](g: G)(implicit ev: Graph[G, N, E]) {
