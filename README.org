...
> runMain scalaam.cli.SchemeRunAAM test/church.scm # run it with AAM (~15s)
> runMain scalaam.cli.SchemeRunGAAM test/church.scm # run it with AAM and a global store (~1s)
#+END_SRC
